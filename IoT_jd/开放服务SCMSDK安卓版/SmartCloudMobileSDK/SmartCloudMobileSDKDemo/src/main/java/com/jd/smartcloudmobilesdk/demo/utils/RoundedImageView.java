...
import com.jd.smartcloudmobilesdk.demo.utils.RoundedDrawable.Corner;
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMutateBackground = a.getBoolean(R.styleable.RoundedImageView_round_background, false);
        mIsOval = a.getBoolean(R.styleable.RoundedImageView_is_oval, false);

        mMutateBackground = mIsOval;
