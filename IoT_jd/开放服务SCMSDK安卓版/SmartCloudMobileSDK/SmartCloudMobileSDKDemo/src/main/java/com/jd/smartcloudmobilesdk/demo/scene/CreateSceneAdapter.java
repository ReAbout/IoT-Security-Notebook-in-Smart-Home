 ...
 */
public class CreateSceneAdapter extends ArrayListAdapter<SceneDetail> {

    public CreateSceneAdapter(Context context) {
        super(context);
    }
...
//            holder.iconView.setImageResource(R.mipmap.device_occupied);
