 ...
 */
public class SceneActionsListActivity extends BaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
            ...
            public void onSuccess(String response) {
                ...
                if (CommonUtil.isSuccess(response)) {
                    try {
                        ...
                        String list = new JSONObject(result).optString("list");
...
//        activity.saveData(trigger, response);
    ...
    private void showDialog(String name, DeviceStream data, TextView echo, TextView item_choose) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_dc_opts, null);
    ...
    public void onBackPressed() {
        ...
        setResult(CreateSceneActivity.CODE_ACTION, intent);
    ...
    private class EventsAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(SceneActionsListActivity.this).inflate(R.layout.scene_event_list_parent_item, null);
                holder = new ParentViewHolder();
                holder.tv_name = (TextView) convertView.findViewById(R.id.tv_name);
                holder.iv_fold = (ImageView) convertView.findViewById(R.id.iv_fold);
                convertView.setLayoutParams(new AbsListView.LayoutParams(AbsListView.LayoutParams.MATCH_PARENT, DisplayUtils.dip2px(SceneActionsListActivity.this, 60)));
        ...
        public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(SceneActionsListActivity.this).inflate(R.layout.scene_event_list_child_item, null);
